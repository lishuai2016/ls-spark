 ...
 *
 */
public class GroupTop3 extends HadoopBase {
	...
	public static void main(String[] args) {
		...
		JavaPairRDD<String, Iterable<Integer>> groupedPairs = pairs.groupByKey();//分组
		...
		JavaPairRDD<String, Iterable<Integer>> top3Score = groupedPairs.mapToPair(
				...
				new PairFunction<Tuple2<String,Iterable<Integer>>, String, Iterable<Integer>>() {
					...
					public Tuple2<String, Iterable<Integer>> call(
						...
						String className = classScores._1;//一组名称
						Iterator<Integer> scores = classScores._2.iterator();//一组数据

						while(scores.hasNext()) {//计算一组数据的top3
