...
//mapPartitions以及学生成绩查询案例
public class MapPartitions extends HadoopBase {
	...
	public static void main(String[] args) {
		...
		JavaRDD<Double> studentScoresRDD = studentNamesRDD.mapPartitions(
				...
				new FlatMapFunction<Iterator<String>, Double>() {
					...
					@Override
					public Iterator<Double> call(Iterator<String> iterator)
							throws Exception {
						...
						while(iterator.hasNext()) {
							String studentName = iterator.next();//学生的名字
							Double studentScore = studentScoreMap.get(studentName);//查找这个人的成绩
