 ...
 *
 */
public class DailyTop3Keyword extends HadoopBase{
	...
	public static void main(String[] args) {
		...
		JavaRDD<String> rawRDD = sc.textFile("keyword.txt");
		...
		JavaRDD<String> filterRDD = rawRDD.filter(new Function<String, Boolean>() {
			...
			public Boolean call(String log) throws Exception {
				...
				String city = logSplited[3];//城市
				String platform = logSplited[4];//平台
				String version = logSplited[5];//版本
		...
		JavaPairRDD<String, Long> dateKeywordUvRDD = dateKeywordUsersRDD.mapToPair(
				...
				new PairFunction<Tuple2<String,Iterable<String>>, String, Long>() {
					...
					public Tuple2<String, Long> call(
						...
						String dateKeyword = dateKeywordUsers._1;//日期_搜索词
						Iterator<String> users = dateKeywordUsers._2.iterator();//用户列表
		...
		finalDF.write().format("json").save("D:\\spark-warehouse\\daily_top3_keyword_uv");
		sc.close();
	}
