 ...
 *
 */
public class JSONDataSource extends HadoopBase {
	...
	public static void main(String[] args) {
		...
		// 获取名字列表（将DataFrame转换为rdd，执行transformation操作）
		...
		JavaPairRDD<String, Tuple2<Integer, Integer>> goodStudentsRDD =
				...
				goodStudentScoresDF.javaRDD().mapToPair(new PairFunction<Row, String, Integer>() {
					...
					@Override
					public Tuple2<String, Integer> call(Row row) throws Exception {//名字和分数对
					...
					public Tuple2<String, Integer> call(Row row) throws Exception {
						return new Tuple2<String, Integer>(row.getString(0),//name和age对
								Integer.valueOf(String.valueOf(row.getLong(1))));
					}
		...
		goodStudentsDF.write().format("json").save("D:\\spark-warehouse\\good-students");
	}
