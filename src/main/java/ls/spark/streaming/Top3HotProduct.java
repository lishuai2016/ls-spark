 ...
 *
 */
public class Top3HotProduct extends HadoopBase {
	...
	public static void main(String[] args) throws Exception {
		...
		// 获取输入数据流
		JavaReceiverInputDStream<String> productClickLogsDStream = jssc.socketTextStream("127.0.0.1", 9999);
		...
		categoryProductCountsDStream.foreachRDD(new VoidFunction<JavaPairRDD<String,Integer>>() {
			...
			public void call(JavaPairRDD<String, Integer> categoryProductCountsRDD) throws Exception {
				...
				SQLContext hiveContext = new SQLContext(categoryProductCountsRDD.context());
