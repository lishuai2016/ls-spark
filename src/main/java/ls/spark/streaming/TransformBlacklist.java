 ...
 * 这里案例，完全脱胎于真实的广告业务的大数据系统，业务是真实的，实用
 ...
 它可以用于实现，DStream API中所没有提供的操作。比如说，DStream API中，并没有提供将一个DStream中的每个batch，
 ...
 *
 */
public class TransformBlacklist extends HadoopBase {
	...
	public static void main(String[] args) throws Exception{
		...
		JavaReceiverInputDStream<String> adsClickLogDStream = jssc.socketTextStream("127.0.0.1", 9999);
